...
<div class="title">
<button class="new_holder_btn round4" onclick="javascript:showHideDiv('new_project')">+ | new application</button>Your Content Apps
</div>
...
<span class="detail">texts: <?=$project->getTextCount() ?></span>
</div>
